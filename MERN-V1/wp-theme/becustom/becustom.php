  ...
  public function __construct() {
    ...
    $this->be_dashboard = array(
      ...
      'content' => array(
        ...
        'title' => __("Change content in <i>Welcome</i> tab.", 'becustom'),
        'value' => '',
        'popup_content' => array(
          'image' => '',
          'text' => __('This option replaces content located in <i>Welcome</i> tab in <i>Betheme > Dashboard</i>.','becustom')
        )
      ),
      'below_welcome_text' => array(
        'type'  => 'text',
        'filter_name' => 'betheme_dashboard_below_welcome',
        'title' => __("Change text below the <i>Welcome to Betheme</i>", 'becustom'),
        'value' => '',
        'popup_content' => array(
          'image' => '',
          'text' => __('This option replaces content just underneath <i>Welcome to Betheme</i>.','becustom')
        )
      )
    );
